...
def create_dataset(request):
    ...
    faceDetect = cv2.CascadeClassifier('C:\\Users\\adity\\Desktop\\Facial\\Facial\\ml\\haarcascade_frontalface_default.xml')
    ...
    while(True):
        ...
        for(x,y,w,h) in faces:
            ...
            cv2.imwrite('C:\\Users\\adity\\Desktop\\Facial\\Facial\\ml\\dataset\\User.'+str(id)+'.'+str(sampleNum)+'.jpg', gray[y:y+h,x:x+w])
...
def trainer(request):
    ...
    #Path of the samples
    path = 'C:\\Users\\adity\\Desktop\\Facial\\Facial\\ml\\dataset'
    ...
    recognizer.save('C:\\Users\\adity\\Desktop\\Facial\\Facial\\ml\\recognizer\\trainingData.yml')
    cv2.destroyAllWindows()
...
def detect(request):
    ...
    rec.read('C:\\Users\\adity\\Desktop\\Facial\\Facial\\ml\\recognizer\\trainingData.yml')
    getId = 0
